...
: ${AMENT_CURRENT_PREFIX:="/home/jayaaraju/waiter_robot_ws/src/install/motor_control"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/motor_control/environment/library_path.sh"
